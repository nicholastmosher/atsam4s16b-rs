...
#[doc = r" Proxy"]
pub struct _PLLBCOUNTW<'a> {
    w: &'a mut W,
}
impl<'a> _PLLBCOUNTW<'a> {
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
        const MASK: u8 = 63;
...
impl W {
    ...
    #[doc = "Bits 8:13 - PLLB Counter"]
    #[inline]
    pub fn pllbcount(&mut self) -> _PLLBCOUNTW {
        _PLLBCOUNTW { w: self }
    }
    #[doc = "Bits 16:26 - PLLB Multiplier"]
    #[inline]
    pub fn mulb(&mut self) -> _MULBW {
        _MULBW { w: self }
    }
}
