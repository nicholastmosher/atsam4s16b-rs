...
impl W {
    ...
    #[doc = "Bit 0 - Reset Endpoint 0"]
    #[inline]
    pub fn ep0(&mut self) -> _EP0W {
        _EP0W { w: self }
    }
    #[doc = "Bit 1 - Reset Endpoint 1"]
    #[inline]
    pub fn ep1(&mut self) -> _EP1W {
        _EP1W { w: self }
    }
    #[doc = "Bit 2 - Reset Endpoint 2"]
    #[inline]
    pub fn ep2(&mut self) -> _EP2W {
        _EP2W { w: self }
    }
    #[doc = "Bit 3 - Reset Endpoint 3"]
    #[inline]
    pub fn ep3(&mut self) -> _EP3W {
        _EP3W { w: self }
    }
    #[doc = "Bit 4 - Reset Endpoint 4"]
    #[inline]
    pub fn ep4(&mut self) -> _EP4W {
        _EP4W { w: self }
    }
    #[doc = "Bit 5 - Reset Endpoint 5"]
    #[inline]
    pub fn ep5(&mut self) -> _EP5W {
        _EP5W { w: self }
    }
    #[doc = "Bit 6 - Reset Endpoint 6"]
    #[inline]
    pub fn ep6(&mut self) -> _EP6W {
        _EP6W { w: self }
    }
    #[doc = "Bit 7 - Reset Endpoint 7"]
    #[inline]
    pub fn ep7(&mut self) -> _EP7W {
        _EP7W { w: self }
    }
}
