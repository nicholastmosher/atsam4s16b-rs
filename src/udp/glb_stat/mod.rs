...
impl W {
    ...
    #[doc = "Bit 0 - Function Address Enable"]
    #[inline]
    pub fn fadden(&mut self) -> _FADDENW {
        _FADDENW { w: self }
    }
    #[doc = "Bit 1 - Configured"]
    #[inline]
    pub fn confg(&mut self) -> _CONFGW {
        _CONFGW { w: self }
    }
    #[doc = "Bit 2 - Enable Send Resume"]
    #[inline]
    pub fn esr(&mut self) -> _ESRW {
        _ESRW { w: self }
    }
    #[doc = "Bit 3"]
    #[inline]
    pub fn rsminpr(&mut self) -> _RSMINPRW {
        _RSMINPRW { w: self }
    }
    #[doc = "Bit 4 - Remote Wake Up Enable"]
    #[inline]
    pub fn rmwupe(&mut self) -> _RMWUPEW {
        _RMWUPEW { w: self }
    }
}
